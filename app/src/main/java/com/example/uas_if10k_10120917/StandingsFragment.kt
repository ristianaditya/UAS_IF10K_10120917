...
import StandingsAdapter
import TopScoredAdapter
...
class StandingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerview = rootView.findViewById<RecyclerView>(R.id.recyclerviewStandings)
        val list = ArrayList<StandingsResponse>()
        ...
        apiService.getStandings().enqueue(object : retrofit2.Callback<ArrayList<StandingsResponse>>  {
            override fun onResponse(
                call: Call<ArrayList<StandingsResponse>>,
                response: Response<ArrayList<StandingsResponse>>
            ) {
                if (response.isSuccessful) {
                    response.body()?.let { list.addAll(it) }
                    val adapter = StandingsAdapter(list)
            ...
            override fun onFailure(call: Call<ArrayList<StandingsResponse>>, t: Throwable) {
